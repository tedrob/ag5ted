...
export class PlayerService {
  ...
  private playerlists: Player[] = [
    ...
    new Player('_ST6ZRbhGiA', 'Alicia Keys-YouDon`tKnowMyName'),
    new Player('WWGtyKcAb9U', 'Whispers - Bingo LP'),
    ...
    new Player('LZ055ilIiN4', 'Amanda Gorman eads Inauguration'),
    ...
    new Player('I`m_qewI-1cEs', 'Honey Dijon Boiler Room'),
